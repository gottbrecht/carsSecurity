...
public class CustomOAuth2AccessDeniedHandler<AbstractOAuth2TokenAuthenticationToken> implements AccessDeniedHandler {
    ...
    public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException e)
        ...
        //Refactor
        String wwwAuthenticate = dat3.security.error.CustomOAuth2AuthenticationEntryPoint.computeWWWAuthenticateHeaderValue(parameters);
